              ...
              <table class="table table-striped">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><?php echo htmlspecialchars( $value1["msregistry"], ENT_COMPAT, 'UTF-8', FALSE ); ?></td>
                    <td><?php echo htmlspecialchars( $value1["price"], ENT_COMPAT, 'UTF-8', FALSE ); ?></td>
                    <td><?php if( $value1["recipe"] == 1 ){ ?>Sim<?php }else{ ?>Não<?php } ?></td>
                    <td><?php echo htmlspecialchars( $value1["discount"], ENT_COMPAT, 'UTF-8', FALSE ); ?></td>
